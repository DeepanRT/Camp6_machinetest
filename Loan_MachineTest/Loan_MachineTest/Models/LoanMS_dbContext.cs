...
namespace Loan_MachineTest.Models
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=TUFF15\\SQLEXPRESS01; Initial Catalog=LoanMS_db; Integrated security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CustomerTbl>(entity =>
            {
                entity.HasKey(e => e.CId)
                    .HasName("PK__customer__213EE774D948B7CA");
            ...
            modelBuilder.Entity<LoanDetailsTbl>(entity =>
            {
                entity.HasKey(e => e.LoanId)
                    .HasName("PK__LoanDeta__A1F79554C326AA3C");
            ...
            modelBuilder.Entity<LoginTbl>(entity =>
            {
                entity.HasKey(e => e.LId)
                    .HasName("PK__Login_tb__4208A4A63C6CC7C0");
